...
| **0.18** | 🚧&nbsp;**In&nbsp;progress** | 2026&#8209;07&#8209;15 | **LUX Weave — the interoperability layer** — the substrate that lets independent apps compose across shared business concepts. **Value help shipped (0.18.0)** — a searchable picker one module can open from another, with the provider authorizing the open. Still landing on this line: cross-app navigation between related records, dashboard composition, and a central launchpad. |
