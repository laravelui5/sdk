...
| **0.20** | 🚧&nbsp;**In&nbsp;progress** | –                      | **Hardening** — a round of per-surface polish across the completed core (Partners, Settings, and their companion apps) before it's frozen at `1.0`. No new surface; steadying what's there.                                                                                                              |
